...
class InstaUserTableViewCell: UITableViewCell {
...
//        userInfoButton.addTarget(self, action: #selector(expandCell) , for: .touchUpInside)

    }
    
//    @objc func expandCell(){
//        let vc = InstagramTableViewCell()
//        vc.instaButton.isHidden = true
//    }
